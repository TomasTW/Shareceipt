...
class FriendManager {
    ...
    removeFriend(id) {
        ...
        if (friend && (friend.name.toLowerCase() === 'you' || friend.id === 1)) {
            return;
        }
    ...
    updateFriendList() {
        ...
        this.friends.forEach(friend => {
            ...
            if (!friendElement.length) {
                ...
                let initials = 'ME';
                if (friend.name.toLowerCase() !== 'you' && friend.name !== 'Friend1') {
                ...
                this.friendListElement.append(`
                    <div class="friend" data-id="${friend.id}">
                        <div class="friend-avatar-container">
                            ...
                            ${friend.name.toLowerCase() !== 'you' ? `<button class="delete-btn" data-id="${friend.id}"><i class="fa-solid fa-xmark"></i></button>` : ''}
                        </div>
